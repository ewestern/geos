...
import qualified GEOS.Raw.Serialize as RS
...
handle = initializeGEOS putStrLn error
reader = RS.createReader handle
geo = RS.readHex handle reader trail
...
{-main = do-}
  ...
  {-g <- RS.readHex h r trail-}
  {-putStrLn "Read hex"-}
  {-ng <- convertGeometryFromRaw h g-}
  {-print ng-}
